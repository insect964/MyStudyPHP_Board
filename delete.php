...
<html>
    ...
    <body>
        ...
        <?php endif; ?>
        <p class="text-confirm">以下の投稿を削除します。<br>問題なければ「削除」を押してください。</p>
        <form method="post">
            <div>
                ...
                elseif(!empty($user_name)) { echo htmlspecialchars($user_name,ENT_QUOTES,'UTF-8');} ?>" placeholder="葵屋太郎" disabled>
            </div>
            <div>
                <label for="message">内容</label>
                <textarea name="message" id="message" disabled><?php if(!empty($message_data['message']))
